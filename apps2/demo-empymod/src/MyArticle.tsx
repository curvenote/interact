...
import { RDisplay, RScope, RDynamic, RVar } from "common";
    ...
    <RScope name="page">
      ...
      <article className="centered">
        ...
        <ul>
          <li>
            <p>
              ...
              look at an old problem: Geophysics, 80(1), F1–F18; DOI:
        ...
        <ul>
          ...
          <li>
            <p>Source at the origin, x-directed.</p>
          </li>
          <li>
            <p>
        ...
        />
        <p>The figure shows the main points of Equations (2) and (3):</p>
        <ul>
          <li>
            <p>
